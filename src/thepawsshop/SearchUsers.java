...
public class SearchUsers extends javax.swing.JFrame {
    ...
    public void Show(String value){
        ...
        try{
            ...
            Class.forName("com.mysql.jdbc.Driver");
            sqlConn = DriverManager.getConnection(dataConn, username, password);
            pst = sqlConn.prepareCall("select * from users where First_Name=? or Last_Name=? or User_ID=?");
            ...
            while (rs.next()){
                ...
                String uPhone = String.valueOf(rs.getInt("Phone_No"));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "First Name", "Last Name", "Phone No", "Address", "Email", "Role", "Status"
            }
        ));
        ...
        jLabel12.setText("Search Employees");
